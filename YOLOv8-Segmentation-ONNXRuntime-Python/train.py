...
if __name__ == '__main__':
        model = YOLO(r'yolov8.yaml').load("yolov8n.pt")
        model.train(
                data=r'D:\Downloads\ultralytics-main\ultralytics-main\ultralytics\cfg\datasets\test_partimg.yaml',
                ...
                project='runs/test_partimg',  # (str, optional) 项目名称
